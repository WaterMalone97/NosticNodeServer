...
router.get('/callback', async (req, res) => {
    ...
    let authOptions = {
        ...
        form: {
            ...
            code: code,
            redirect_uri,
            scope: 'streaming user-library-read user-library-modify'
        },
        headers: {
...
router.get('/get-library', async (req, res) => {
   ...
   let songList = await this._ctx.songHelper.getSavedSongList(options);
   let songs = songList.map(song => song.track)
  //  await this._ctx.songQuery.insertIfNotExists(songs); 
